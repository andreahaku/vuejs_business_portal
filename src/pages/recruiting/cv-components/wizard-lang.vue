        ...
        <div class="media-body">
             <div class="media v-middle">
               <div class="media-right">
                 <h4 class="text-headline margin-none">Conoscenze Linguistiche
                 </h4>
               </div>
             </div>
                    ...
                    <div class="col-xs-12 col-md-10">
                      ...
                      <div class="col-xs-12 row">
                           <div class="form-group col-xs-12 col-md-6" style="padding-left: 0px;">
                              <label for="nome" class="col-sm-12 control-label" style="padding-left: 0px;"><strong>* </strong>Madrelingua(e)</label>
                              <div class="col-sm-12" style="padding-left: 0px;">
                                <input type="text" class="form-control checkableInput" placeholder="Italiana, Italiana e Inglese..." 
                                v-model="madrelingua"
                       ...
                       <transition-group name='roll-fade'>
                            <form class="form-horizontal row" v-for="(lang, index) in langs" :key="index">
                                <div class="form-group col-xs-12 col-md-6">
                                  <label for="nome" class="col-sm-12 control-label"><strong>* </strong>Lingua</label>
                                  <div class="col-sm-12">
                                    <input type="text" class="form-control checkableInput" placeholder="Inglese, Spagnolo..." 
                                ...
                                <div class="form-group col-xs-12 col-md-6">
                                  ...
                                  <div class="col-sm-12">
                                    <input type="text" class="form-control checkableInput" placeholder="B2, B1, C1 ..." 
                                ...
                                <div class="form-group col-xs-12 col-md-6">
                                  ...
                                  <div class="col-sm-9">
                                    <form>
                                      <input type="radio" name="gender" value="Discreto" v-model="lang.required.comprensione"> Discreto<br>
                                      <input type="radio" name="gender" value="Buono" v-model="lang.required.comprensione"> Buono<br>
                                      <input type="radio" name="gender" value="Ottimo" v-model="lang.required.comprensione"> Ottimo
                                    </form>
                                  </div>
                                </div>
                                ...
                                <div class="form-group col-xs-12 col-md-6">
                                  ...
                                  <div class="col-sm-9">
                                    <form>
                                      <input type="radio" name="gender" value="Discreto" v-model="lang.required.parlato"> Discreto<br>
                                      <input type="radio" name="gender" value="Buono" v-model="lang.required.parlato"> Buono<br>
                                      <input type="radio" name="gender" value="Ottimo" v-model="lang.required.parlato"> Ottimo
                                    </form>
                                  </div>
                                </div>
