...
<script>
    ...
    import editable from './esp-lavorative-editable.vue';
    import saved from './esp-lavorative-saved.vue';
    ...
    export default {
        ...
        created(){
            //todo
            var vm = this;
            eventBus.$on('WorkSwitch', function(obj) {
