 ...
 export default {
  ...
  mounted: function() {
    ...
    this.control.summernote({
      ...
      callbacks: {
        onInit: function() {
          me.control.summernote("code", me.stringmodel);
        }
      }
      ...
      if (! me.isChanging) {
        ...
        me.stringmodel = (code === null || code.length === 0 ? null : code);
  ...
  data: function(){
      var vm = this;
      return {
          stringmodel: vm.value
      }
  },
  watch: {
    "model": function () {
        this.stringmodel = this.value
      
    },
    stringmodel: function(){
        if (! this.isChanging) {
            this.isChanging = true;
            var code = (this.value === null ? "" : val);
            this.control.summernote("code", code);
            this.isChanging = false;
        }
        this.$emit("input", this.stringmodel)
    }
  }
};
 </script>
