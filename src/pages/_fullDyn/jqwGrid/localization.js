export const localizationMixin = {
    methods: {
        getLocalization: function (culture) {
            ...
            switch (culture) {
                ...
                case "it":
                    localization = {
                        ...
                        pagershowrowsstring: "Righe per pagina:",
                        pagerrangestring: " di ",
                        pagerpreviousbuttonstring: "inditro",
                        pagernextbuttonstring: "avanti",
                        pagerfirstbuttonstring: "primo",
                        pagerlastbuttonstring: "ultimo",
                        groupsheaderstring: "Trascina quì una colonna per effettuare un raggruppamento",
                        sortascendingstring: "Ordinamento Crescente",
                        sortdescendingstring: "Ordinamento Decrescente",
                        sortremovestring: "Rimuovi Ordinamento",
                        groupbystring: "Raggruppa per questa colonna",
                        groupremovestring: "Rimuovi dal raggruppamento",
                        filterclearstring: "Annulla",
                        filterstring: "Filtra",
                        filtershowrowstring: "Mostra se:",
                        filterorconditionstring: "O",
                        filterandconditionstring: "E",
                        filterselectallstring: "(Seleziona tutto)",
                        filterchoosestring: "",
                        filterstringcomparisonoperators: ['vuoto', 'presente', 'contiene', 'contiene (controllo maiuscole)',
                            'non contiene', 'non contiene (controllo maiuscole)', 'comincia con', 'comincia con (controllo maiuscole)',
                            'termina con', 'termina con (controllo maiuscole)', 'coincide', 'coincide (controllo maiuscole)', 'vuoto', 'presente'
                        ],
                        filternumericcomparisonoperators: ['uguale', 'diverso', 'minore di', 'minore o uguale', 'maggiore di', 'maggiore o uguale', 'vuoto', 'presente'],
                        filterdatecomparisonoperators: ['uguale', 'diverso', 'minore di', 'minore o uguale', 'maggiore di', 'maggiore o uguale', 'vuoto', 'presente'],
                        filterbooleancomparisonoperators: ['uguale', 'diverso'],
                        validationstring: "Il valore inserito non è valido",
                        emptydatastring: "Nessun risultato soddisfa i parametri di ricerca",
                        filterselectstring: "Scegli filtro",
