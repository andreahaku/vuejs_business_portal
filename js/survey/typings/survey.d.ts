// Type definitions for Survey JavaScript library v0.9.9
...
declare module Survey {
    ...
    class ItemValue {
        ...
        private itemText;
        private itemCorrect;
        constructor(value: any, text?: string, correct?: boolean);
        getType(): string;
        value: any;
        hasText: boolean;
        text: string;
...
declare module Survey {
    class PageModel extends Base implements IPage {
        ...
        hasErrors(focuseOnFirstError?: boolean): boolean;
...
declare module Survey {
    class QuestionSelectBase extends Question {
        ...
        supportOther(): boolean;
        protected onCheckForErrors(errors: Array<SurveyError>): void;
        protected storeOthersAsComment: boolean;
...
/// <reference path="../kosurvey.d.ts" />
/// <reference path="../../defaultCss/cssbootstrap.d.ts" />
declare module Survey {
